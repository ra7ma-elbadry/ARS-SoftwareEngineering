...
public class MenuDAOImpl implements MenuDAO {
    ...
    public List<Menu> getAllMenu() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Menu menu = creaMenuDaResultSet(rs);
    ...
    public List<Menu> getMenuDisponibile() {
        ...
        String sql =
                "SELECT * FROM Menu WHERE disponibile = 1";
        ...
        try {
            ...
            System.out.println(
                    "Errore durante il caricamento del menu disponibile:"
            );
    ...
    public void aggiungiMenu(Menu menu) {
        ...
        try {
            ...
            System.out.println(
                    "Errore durante l'aggiunta del piatto al menu:"
            );
    ...
    public void aggiornaDisponibilita(
        ...
        try {
            ...
            System.out.println(
                    ...
                    + "della disponibilità del piatto:"
            );
    ...
    private Menu creaMenuDaResultSet(ResultSet rs)
            throws Exception {

...
public class PrenotazioneEventoDAOImpl implements PrenotazioneEventoDAO {
    ...
    public void salvaPrenotazione(PrenotazioneEvento prenotazione) {
        ...
        try {
            ...
            System.out.println(
                    "Errore durante il salvataggio della prenotazione evento:"
            );
            e.printStackTrace();
        }
    }
    ...
    public List<PrenotazioneEvento> getTuttePrenotazioni() {
        ...
        List<PrenotazioneEvento> listaPrenotazioni =
                new ArrayList<>();
        ...
        try {
            ...
            System.out.println(
                    "Errore durante il caricamento delle prenotazioni evento:"
            );
            e.printStackTrace();
        }
    ...
    public void eliminaPrenotazione(int idPrenotazione) {
        ...
        String sql =
                "DELETE FROM PrenotazioneEvento "
        ...
        try {
            ...
            System.out.println(
                    "Errore durante l'eliminazione della prenotazione evento:"
            );
            e.printStackTrace();
        }
    }
    ...
    public void modificaPrenotazione(
        ...
        try {
            ...
            System.out.println(
                    "Errore durante la modifica della prenotazione evento:"
            );
            e.printStackTrace();
        }
    }
    ...
    @Override
    public boolean salaDisponibile(
            int idSala,
            String dataEvento,
            String oraInizio,
            String oraFine) {
        ...
        String sql =
                "SELECT COUNT(*) FROM PrenotazioneEvento "
                + "WHERE id_sala = ? "
                + "AND data_evento = ? "
                + "AND stato != 'ANNULLATA' "
        ...
        try {
            ...
            System.out.println(
                    "Errore controllo disponibilità sala:"
            );
            e.printStackTrace();
        }

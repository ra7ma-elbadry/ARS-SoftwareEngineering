...
public class OrdinazioneDAOImpl implements OrdinazioneDAO {

    @Override
    public int creaOrdinazione(Ordinazione ordinazione) {

        String sql = "INSERT INTO Ordinazione "
                + "(id_tavolo, id_cameriere, data_ora, stato, totale) "
                + "VALUES (?, ?, ?, ?, ?)";
        ...
        try {
            ...
            System.out.println(
                    "Errore durante la creazione dell'ordinazione:"
            );
    ...
    public List<Ordinazione> getAllOrdinazioni() {
        ...
        try {
            ...
            System.out.println(
                    "Errore durante il caricamento delle ordinazioni:"
            );
    ...
    public List<Ordinazione> getOrdinazioniPerCucina() {
        ...
        try {
            ...
            System.out.println(
                    "Errore durante il caricamento delle ordinazioni per cucina:"
            );
    ...
    public void aggiornaStatoOrdinazione(
        ...
        try {
            ...
            System.out.println(
                    "Errore durante l'aggiornamento dello stato dell'ordinazione:"
            );
    ...
    public List<Ordinazione> getOrdinazioniPronteOConsegnate() {
        ...
        String sql =
                "SELECT * FROM Ordinazione "
                + "WHERE stato IN ('PRONTO', 'CONSEGNATO')";
        ...
        try {
            ...
            System.out.println(
                    ...
                    + "delle ordinazioni pronte/consegnate:"
            );
    ...
    public Ordinazione getOrdinazioneById(int idOrdinazione) {
        ...
        try {
            ...
            System.out.println(
                    "Errore durante il caricamento dell'ordinazione:"
            );
    ...
    private Ordinazione creaOrdinazioneDaResultSet(ResultSet rs)
            throws Exception {
